    ...
    edit: function edit(props) {
        ...
        jsx = [wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(SelectControl, {
                    ...
                    options: [{ value: '', label: __('-- Select A Music Player --', 'all-in-one-music-player') }, { value: 'a-player', label: 'APlayer' }, { value: 'circular-spikes', label: 'Circular Spikes' }, { value: 'flat-black', label: 'Flat Black' }, { value: 'blue-playlist', label: 'Blue Playlist' }],
        ...
        if (theme) {
            ...
            jsx.push(wp.element.createElement(
                ...
                wp.element.createElement('img', { src: 'https://sanjeebaryal.com.np/wp-content/plugins/internet-connection-status/assets/logo.png' }),
                wp.element.createElement(
                    'h3',
                    null,
                    ' ',
